...
export class GoogleDriveService {
   ...
   */
  public async listFiles(params: ListFilesParams = {}): Promise<ApiResponse<ListFilesResponse>> {
    try {
   ...
   * Get file metadata
   */
  public async getFileMetadata(fileId: string): Promise<ApiResponse<FileMetadata>> {
    try {
   ...
   */
  public async downloadFile(fileId: string, destPath: string): Promise<ApiResponse<{ path: string }>> {
    try {
   ...
   */
  public async deleteFile(fileId: string): Promise<ApiResponse<{ message: string }>> {
    try {
